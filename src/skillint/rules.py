...
KNOWN_FIELDS = frozenset({
    "name", "description", "version", "author", "license", "tags", "model",
    "allowedTools", "allowed-tools", "requiredPermissions", "required-permissions",
})
...
def frontmatter_rules(skill: ParsedSkill) -> List[Issue]:
    ...
    if isinstance(desc_val, str):
        ...
        if len(trimmed) >= MIN_DESCRIPTION_LENGTH and not _TRIGGER_WORDS_RE.search(trimmed):
            issues.append(Issue(
